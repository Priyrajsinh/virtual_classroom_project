...
?>
	...
	<?php
                    ...
                    if($status==0)
                    {
                        echo "<a href=approvesubassignment.php?aid=".$aid."><i class='fas fa-check'>&nbsp; Approve</i>  </a>";
                        echo "<a href=rejectsubassignment.php?aid=".$aid."><i class='fas fa-times'>&nbsp; Reject</i></a>";
                    }
                    elseif($status == 1)
                    {
                      echo "<a href=rejectsubassignment.php?aid=".$aid."><i class='fas fa-times'>&nbsp; Reject</i></a>";
                    ...
                    ?>
                    <a href="deletesubassignment.php?aid=<?php echo $aid;?>"><i class="fas fa-trash">&nbsp;Delete</i></a>
