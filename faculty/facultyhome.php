        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="facultyhome.php">Home</a></li>
		  ...
		  <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <?php
              include "include/connection.php";
              $cmd="select count(astatus) from students where astatus='0'";
              $result= mysqli_query($con,$cmd) or die(mysqli_error($con));
              $row=mysqli_fetch_array($result);
              $total= $row[0];  
              echo"<h3>".$total."</h3>";
              ...
              ?>
                ...
                <p>Pending Assignment List</p>
              </div>
              <div class="icon">
                <i class="ion ion-pie-graph"></i>
              </div>
              <a href="pendingassignment.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
         <div class="col-lg-3 col-6">
