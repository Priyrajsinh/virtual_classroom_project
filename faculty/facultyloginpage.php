  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="facultylogin.php" method="POST">
        ...
        <div class="input-group mb-3">
          &emsp;<label>Captcha Code  :-  </label>&emsp;
		...
		?>
		 <div class="form-group col-4">
		  ...
		  <input type="text" style="background-color: #a9a9a9"  class="form-control" Value = <?php echo "$captcha_code"; ?>  readonly >
			...
			<h6><img src="refresh.jpeg" width="35px" onclick=location.reload()></h6>  
        ...
        <div class="row">
          ...
          <div class="col-12">
			...
			<button type="reset" name="submit" class="btn btn-danger btn-block">Cancel</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
