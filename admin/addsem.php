      ...
      <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method = "POST" action = "insertsem.php">
                <div class="card-body">
                  
                  <div class="form-group">
                    <label for="exampleInputPassword1">Semester Code :</label>
                    <input type="text" name ="scode" class="form-control" id="exampleInputPassword1" placeholder="Enter Semester Code" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Semester Name :</label>
                    <div class="input-group">
                      <div class="custom-file">
					  <input type="text" name ="sname" class="form-control" id="exampleInputPassword1" placeholder="Enter Semester Name" required>
