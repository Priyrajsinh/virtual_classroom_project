                ...
                <div class="card-body">
				 ...
				 <div class="form-group">
				  ...
				  <div class="form-group">
                    ...
                    <input type="email" name="stmail" value="<?php echo $row['stmail']; ?>" class="form-control" id="exampleInputEmail1" placeholder="Enter Students email" required>
                  </div>

					<div class="form-group">
                    <label for="exampleInputEmail1"> Password</label>
                    <input type="password" name="stpass" value="<?php echo $row['stpass']; ?>" class="form-control" id="exa	mpleInputEmail1" placeholder="Enter Students Password"required>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
					  ...
					  <input type="text" name ="stname" value="<?php echo $row['stname']; ?>" class="form-control" id="exampleInputPassword1" placeholder="Enter Students Name" required>
