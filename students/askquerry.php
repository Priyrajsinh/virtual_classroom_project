          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Ask Querry</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Ask Querry</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" action="insertquerry.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <div class="form-group">
                        <label for="exampleInputFile">Ask Queries:</label>
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="text" name="querry" class="form-control" required>
