        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" method="POST" action="insertleave.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
					 ...
					 <div class="form-group">
					 <label for="exampleInputFile">Student Email :</label>
                      <div class="custom-file">
                        <select name="email" class="form-control">
                          <option value="">--Student Email--</option>
                          <?php
                          while ($row4 = mysqli_fetch_array($result4)) {
                            echo "<option value=" . $row4['stmail'] . ">" . $row4['stmail'] . "</option>";
                          }
                          ?>
                        </select>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="exampleInputFile">Subject For Leave:</label>
                        <div class="input-group">
                          <div class="custom-file">
					   ...
					   <div class="form-group">
                        <label for="exampleInputFile">Description/Reason:</label>
                        <div class="input-group">
                          <div class="custom-file">
                  ...
                  <input type="date" name="fdate"  class="form-control" id="exampleInputPassword1" required>
                  </div>
