...
<head>
  ...
  <title>Virtual Classroom | Students</title>
  <?php
...
?>
	...
	<td><a onClick="javascript: return confirm('Are you sure? You want to submit..');" href="submitassignment.php?aid=<?php echo $row['aid'];?>">Submit</a></td>
</tr>
<?php
	}
?>
