              ...
              <form role="form" method = "POST" action = "updatefaculty.php">
                <div class="card-body">
				  ...
				  <div class="form-group">
                    ...
                    <input type="email" name="fmail" value="<?php echo $row['fmail']; ?>" class="form-control" id="exampleInputEmail1" placeholder="Enter Faculty email">
                  </div>

					<div class="form-group">
                    <label for="exampleInputEmail1"> Password</label>
                    <input type="password" name="fpass" value="<?php echo $row['fpass']; ?>" class="form-control" id="exa	mpleInputEmail1" placeholder="Enter Faculty email">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
					  ...
					  <input type="text" name ="fname" value="<?php echo $row['fname']; ?>" class="form-control" id="exampleInputPassword1" placeholder="Enter Faculty Name">
