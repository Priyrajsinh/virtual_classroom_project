              ...
              <form role="form" method = "POST" action = "insertsem.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name ="scode" class="form-control" id="exampleInputPassword1" placeholder="Enter Semester Code">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Semester Name :</label>
                    <div class="input-group">
                      <div class="custom-file">
					  <input type="text" name ="sname" class="form-control" id="exampleInputPassword1" placeholder="Enter Semester Name">
