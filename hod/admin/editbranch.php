              ...
              <form role="form" method = "POST" action = "updatebranch.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name ="bcode" value="<?php echo $row['bcode']; ?>" class="form-control" id="exampleInputPassword1" placeholder="Enter Branch Code">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Branch Name :</label>
                    <div class="input-group">
                      <div class="custom-file">
					  <input type="text" name ="bname" value="<?php echo $row['bname']; ?>" class="form-control" id="exampleInputPassword1" placeholder="Enter Branch Code">
