              ...
              <form role="form" method = "POST" action = "updatehod.php">
                <div class="card-body">
				  ...
				  <div class="form-group">
                    ...
                    <input type="email" name="hmail" value="<?php echo $row['hmail']; ?>" class="form-control" id="exampleInputEmail1" placeholder="Enter HOD email">
                  </div>

					<div class="form-group">
                    <label for="exampleInputEmail1"> Password</label>
                    <input type="password" name="hpass" value="<?php echo $row['hpass']; ?>" class="form-control" id="exa	mpleInputEmail1" placeholder="Enter HOD Password">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
					  ...
					  <input type="text" name ="hname" value="<?php echo $row['hname']; ?>" class="form-control" id="exampleInputPassword1" placeholder="Enter HOD Name">
