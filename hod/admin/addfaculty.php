              ...
              <form role="form" method = "POST" action = "insertfaculty.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name ="fcode" class="form-control" id="exampleInputPassword1" placeholder="Enter Faculty Code">
                  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
                    ...
                    <input type="email" name="fmail" class="form-control" id="exampleInputEmail1" placeholder="Enter Faculty email">
                  </div>

					<div class="form-group">
                    <label for="exampleInputEmail1"> Password</label>
                    <input type="password" name="fpass" class="form-control" id="exa	mpleInputEmail1" placeholder="Enter Faculty email">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
					  ...
					  <input type="text" name ="fname" class="form-control" id="exampleInputPassword1" placeholder="Enter Faculty Name">
