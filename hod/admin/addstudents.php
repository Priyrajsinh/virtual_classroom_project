              ...
              <form role="form" method = "POST" action = "insertstudents.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name ="stcode" class="form-control" id="exampleInputPassword1" placeholder="Enter Students Code">
                  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
                    ...
                    <input type="email" name="stmail" class="form-control" id="exampleInputEmail1" placeholder="Enter Students email">
                  </div>

					<div class="form-group">
                    <label for="exampleInputEmail1"> Password</label>
                    <input type="password" name="stpass" class="form-control" id="exa	mpleInputEmail1" placeholder="Enter Students Password">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
					  ...
					  <input type="text" name ="stname" class="form-control" id="exampleInputPassword1" placeholder="Enter Students Name">
