            ...
            <div class="card card-primary">
              ...
              <form role="form" method = "POST" action = "updatesem.php">
				...
				<div class="form-group">
                    ...
                    <input type="text" name="scode" value="<?php echo $row['scode']; ?>" class="form-control" id="exampleInputPassword1" placeholder="Enter Semester Code">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputFile">Semester Name :</label>
                    <div class="input-group">
                      <div class="custom-file">
					  <input type="text" name ="sname" value="<?php echo $row['sname']; ?>" class="form-control" id="exampleInputPassword1" placeholder="Enter Semester Name">
